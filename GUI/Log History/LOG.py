...
ASSETS_PATH = OUTPUT_PATH / Path(r"E:\gui\Projek\assets\frame0\LOG-Baru")
...
log_textbox.place(
    x=297,
    y=168,
    width=window.winfo_screenwidth() - 1070,  # Sesuaikan dengan lebar layar
    height=window.winfo_screenheight() - 460  # Sesuaikan dengan tinggi layar
)
